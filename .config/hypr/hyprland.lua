...
hl.env("AUR_PASSWORD", "Aurora80247")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(cc241dee)", "rgba(fb4934ee)"}, angle = 45 },
...
hl.bind(main_mod .. " + G", hl.dsp.exec_cmd("steam"))
hl.bind(main_mod .. " + SHIFT + G", hl.dsp.exec_cmd('notify-send -t 10000 -i steam "Launching Steam..." "Just give it second..." && steam'))
-- hl.bind(main_mod .. " + _", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind(main_mod .. " + K", hl.dsp.layout("swapsplit"))    -- dwindle only
hl.bind(main_mod .. " + V", hl.dsp.exec_cmd('cliphist list | fuzzel --dmenu | cliphist decode | wl-copy'))
hl.bind(main_mod .. " + SHIFT + V", hl.dsp.exec_cmd('cliphist list | fuzzel --dmenu | cliphist delete'))
hl.bind(main_mod .. " + C", hl.dsp.exec_cmd('hyprpicker -a && notify-send "Color Copied" "$(wl-paste)" -t 3000'))
hl.bind(main_mod .. " + W", hl.dsp.exec_cmd('systemctl --user restart waybar'))
hl.bind(main_mod .. " + H", hl.dsp.exec_cmd('hyprctl reload && notify-send -t 1000 -i ~/Downloads/favicon.png "Hyprland Reloaded!" "You\'re good to go!"'))
...
-- Screenshotting
hl.bind(main_mod .. " + S",         hl.dsp.exec_cmd('hyprshot -m region -o ~/Pictures/Screenshots'))
hl.bind(main_mod .. " + SHIFT + S", hl.dsp.exec_cmd('hyprshot -m window -o ~/Pictures/Screenshots'))
hl.bind(main_mod .. " + CTRL + S",  hl.dsp.exec_cmd('hyprshot -m output -o ~/Pictures/Screenshots'))
...
hl.bind("SHIFT + XF86MonBrightnessUp",   hl.dsp.exec_cmd("hyprctl hyprsunset gamme +2"),           { locked = true, repeating = true })
hl.bind("SHIFT + XF86MonBrightnessDown", hl.dsp.exec_cmd("hyprctl hyprsunset gamme -2"),           { locked = true, repeating = true })
...
-- Without using laptop multimedia keys
hl.bind(main_mod .. " + ALT + right", hl.dsp.exec_cmd("playerctl next"),       { locked = true })
hl.bind(main_mod .. " + ALT + down",  hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind(main_mod .. " + ALT + up",    hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind(main_mod .. " + ALT + left",  hl.dsp.exec_cmd("playerctl previous"),   { locked = true })
...
hl.window_rule({
    -- Make PiP auto-resize into the corner
    name  = "make-nice-pip",
    match = { title = "Picture-in-Picture|Зображення в зображенні" },
    float = true,
    pin   = true,
    size  = {"monitor_h/3.6*16/9", "monitor_h/3.6"},
    move  = {"monitor_w-window_w-12", "66"},
    keep_aspect_ratio = true,
})

hl.window_rule({
    -- Set a better size for when RoG control center pops up
    name  = "resize-rog",
    match = { class = "rog-control-center" },
    float = true,
    size  = {"0.55*monitor_w", "0.65*monitor_h"},
})
